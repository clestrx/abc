...
// get slider
const getSliderLoading = () => {
  return {
    type: GET_SLIDER_LOADING,
  };
};

const getSliderSuccess = (data) => {
  return {
...
// create slider
const addSliderLoading = () => {
  return {
    type: ADD_SLIDER_LOADING,
  };
};

const addSliderSuccess = (data) => {
  return {
...
const addSliderError = (error) => {
  return {
    type: ADD_SLIDER_ERROR,
    payload: error,
  };
};
