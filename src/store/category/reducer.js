...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case GET_SLIDER_LOADING:
            return { ...state, getSlider: { ...state.getSlider, loading: true, data: null, error: null } };
        case GET_SLIDER_SUCCESS:
            return { ...state, getSlider: { ...state.getSlider, loading: false, data: action.payload, error: null } };
        case GET_SLIDER_ERROR:
            return { ...state, getSlider: { ...state.getSlider, loading: false, data: null, error: action.payload } };

        case ADD_SLIDER_LOADING:
            return { ...state, addSlider: { ...state.addSlider, loading: true, data: null, error: null } };
        case ADD_SLIDER_SUCCESS:
            return { ...state, addSlider: { ...state.addSlider, loading: false, data: action.payload, error: null } };
        case ADD_SLIDER_ERROR:
            return { ...state, addSlider: { ...state.addSlider, loading: false, data: null, error: action.payload } };
